...
public class GamePanel extends JPanel {
  ...
  private void Render() {
    ...
    unknown_number.setIcon(new ImageIcon(getClass().getClassLoader().getResource("asset/question.png")));
    ...
    submit_button.setIcon(new ImageIcon(getClass().getClassLoader().getResource("asset/submit.png")));
    ...
    continue_button.setIcon(new ImageIcon(getClass().getClassLoader().getResource("asset/button.png")));
    ...
    back_button.setIcon(new ImageIcon(getClass().getClassLoader().getResource("asset/button.png")));
  ...
  private void changeStatusValue(
    ...
    if (guess_field.getText().equals("I love suntana")) {
      ...
      music.soundEffect(getClass().getClassLoader().getResource("asset/correct.wav"));
      unknown_number.setText(String.valueOf(""));
      Image originalImg = new ImageIcon(getClass().getClassLoader().getResource("asset/suntana.png")).getImage();
    ...
    if (Integer.parseInt(guess_field.getText()) == UNKNOW_NUMBER) {
      ...
      guess_field.setText("");
      music.soundEffect(getClass().getClassLoader().getResource("asset/incorrect.wav"));
    } else if (Integer.parseInt(guess_field.getText()) < UNKNOW_NUMBER) {
