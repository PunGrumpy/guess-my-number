...
public class MenuPanel extends JPanel {
  ...
  private void Render() {
    ...
    JLabel play_button = new JLabel(new ImageIcon(getClass().getClassLoader().getResource("asset/play.png")));
  ...
  protected void paintComponent(Graphics g) {
    ...
    g.drawImage(
      new ImageIcon(getClass().getClassLoader().getResource("asset/background.png")).getImage(),
      0,
      0,
      getWidth(),
      getHeight(),
